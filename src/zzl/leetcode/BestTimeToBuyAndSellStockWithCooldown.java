...
public class BestTimeToBuyAndSellStockWithCooldown {
    public static void main(String[] args) {
        ...
        maxProfit = new BestTimeToBuyAndSellStockWithCooldown().maxProfit(prices);
        Assert.assertEquals(maxProfit, 13755);
    }
     ...
     * @param prices
     * @return
     * @link {https://leetcode-cn.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/solution/yi-tu-miao-dong-jie-fa-by-zi-gei-zi-zu/}
     */
    ...
    public int maxProfitDfs_bad(int[] prices) {
        System.out.println("===");
        for (int i = 1; i <= 3; i++) {
            // 第一天选择买入或者不买入
            switch (i) {
